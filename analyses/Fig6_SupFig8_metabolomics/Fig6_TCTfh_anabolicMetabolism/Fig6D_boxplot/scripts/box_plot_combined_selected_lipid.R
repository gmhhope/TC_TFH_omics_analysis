setwd("/Volumes/LM_MG_drive_one/Morel_Metabolomics_comb_1st2nd_spTnTfh_052620/Rm_C2_TC-5/X4_box_plot/09062021_test/")
...
metab_list <- read.csv("./metabolite_list_lipid.csv")
...
multi.page <- ggarrange(plotlist = fig_l,
                        nrow = 3, ncol = 3)
ggexport(multi.page, filename = "lipid_metabolite_boxplot.pdf", width = 10, height = 8)
