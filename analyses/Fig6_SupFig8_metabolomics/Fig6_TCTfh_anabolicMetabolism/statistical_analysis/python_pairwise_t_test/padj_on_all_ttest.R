...
setwd("/Volumes/LM_MG_drive_one/Morel_Metabolomics_comb_1st2nd_spTnTfh_052620/Rm_C2_TC-5/X2_statistical_test/python_pairwise_t_test/")
file_name = "ttest4_TC_TfhvsTC_Tn.txt"
df <- read.table(file_name, header = TRUE)
dim(df)
