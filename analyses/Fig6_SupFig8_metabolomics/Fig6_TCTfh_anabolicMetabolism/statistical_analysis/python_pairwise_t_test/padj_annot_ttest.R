...
setwd("/Volumes/LM_MG_drive_one/Morel_Metabolomics_2nd_set_spTnTfh_04202020/rv_TC-5/X3_statistical_test/python_pairwise_t_test/")
file_name = "ttest4_B6_TFHvsB6_TN.txt"
df <- read.table(file_name, header = TRUE)
