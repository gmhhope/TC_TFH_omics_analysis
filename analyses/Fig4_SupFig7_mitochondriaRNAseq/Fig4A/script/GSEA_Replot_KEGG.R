...
Workdir <- "/Volumes/LM_MG_drive_one/Morel_RNA-seq_UT_071619received/MG_analysis_071619/B6_TC_2DG_project_11262019/GSEA/output4GSEA/Tfh_TCvsB6_r2/Tfh_TCvsB6_r2_KEGG.GseaPreranked.1575991269794/"
setwd(Workdir)
...
class.name <- "TC versus B6 (Tfh)"
# 
# replotGSEA(path = path, gene.set = gene.set, class.name = class.name)

gene.set.vector <- c("KEGG_FATTY_ACID_METABOLISM",
