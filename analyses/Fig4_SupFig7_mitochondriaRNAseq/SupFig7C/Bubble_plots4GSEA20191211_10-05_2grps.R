setwd("/Volumes/LM_MG_drive_one/Metabolomics_Transcriptome_integration_06042020/Pathway_wise_analysis/TC_Tfh_metabolomics/GSEA_output_july12/Figure4_bubble_plot/")

file_name = "meta_df4bubble_mod_v3.csv"
...
library(ggplot2)
    ...
    pdf(paste("ggplot_bubble_mod",str_extract(file_name, '^[^.]+'),".pdf", sep = "") , width = 8.9, height = 3.6)
