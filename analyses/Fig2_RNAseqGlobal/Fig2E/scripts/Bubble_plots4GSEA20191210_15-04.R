setwd("/Volumes/LM_MG_drive_one/Morel_meta_analyses_transcriptomics/GSEA_TCvsB6_meta_Tfh_Tn/GSEA_GO_meta_TCvsB6_Tfh_Tn/")
...
df_filt$group <- factor(df_filt$group, levels = c("Tfh_TC","Tfh_B6","Tn_TC","Tn_B6"))
...
library(ggplot2)
    ...
    pdf(paste("ggplot_bubble_",str_extract(file_name, '^[^.]+'),".pdf", sep = "") , width = 6.6, height = 5.3) #15, 80
