...
Workdir <- "/Volumes/LM_MG_drive_one/Morel_RNA-seq_UT_071619received/MG_analysis_071619/B6_TC_2DG_project_11262019/GSEA/output4GSEA/TC_TfhvsTn/TC_TfhvsTn_TfhGeneSet.GseaPreranked.1578243630063/"
setwd(Workdir)
path <- Workdir
library(Rtoolbox)
## Script by Thomas Kuilman
...
gene.set <- ""
class.name <- "Tfh versus Tn (TC)"

replotGSEA(path = path, gene.set = gene.set, class.name = class.name)

gene.set.vector <- c("GSE16697_CD4_TCELL_VS_TFH_CD4_TCELL_UP", 
                     "GSE16697_CD4_TCELL_VS_TFH_CD4_TCELL_DN")
