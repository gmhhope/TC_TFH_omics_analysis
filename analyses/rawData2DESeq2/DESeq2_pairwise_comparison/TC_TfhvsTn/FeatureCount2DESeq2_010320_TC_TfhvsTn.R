ctab_loc_dir =  "/Volumes/LM_MG_drive_one/Morel_RNA-seq_UT_071619received/MG_analysis_071619/B6_TC_2DG_project_11262019/DESeq2/TC_TfhvsTn/"
ctab_name = "count_mtx_TC_Tfh_vs_Tn_mod.csv"
colData_name = "pheno_metadata_TC_Tfh_vs_Tn.txt"
key_name = "TC_TfhvsTn"
setwd(ctab_loc_dir)
