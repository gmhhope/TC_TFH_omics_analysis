ctab_loc_dir =  "/Volumes/LM_MG_drive_one/Morel_RNA-seq_UT_071619received/MG_analysis_071619/B6_TC_2DG_project_11262019/DESeq2/Tn_B6vsTC_r2/"
ctab_name = "count_mtx_Tn_B6vsTC_r2.csv"
colData_name = "pheno_metadata_Tn_B6vsTC_r2.txt"
key_name = "Tn_B6vsTC_r2"
setwd(ctab_loc_dir)
...
nrow(assay(rld)) #19349
pdf("plotPCA_rld_ntop_19349_exp.pdf", width = 10, height = 10)
plotPCA(rld,intgroup="Group", ntop = 19349 ) # if returnData=TRUE, return the data; if not, return the plot)
dev.off()
