...
#setwd("")
HT <- read.csv("input/FACS_sign_output4heatmap.csv", header = T, row.names = 1,check.names = F)
...
out_pdf_file = paste("output/Heatmap_","","quantiled_FACS_atleast_sign_Tfh_TCvsB6",".pdf",sep = "")
